...
// 	};
// 	return gulp.src('src/houtai/*.html')
// 		.pipe(minifyhtml(options))
// 		.pipe(gulp.dest('dist/houtai'));
// });
...
// 	return gulp.src('src/sanweitang/css/list.css')
// 		.pipe(minifycss())
// 		.pipe(gulp.dest('dist/sanweitang/css'));
// });
...
// 		.pipe(gulp.dest('dist/sanweitang/js'));//ES6不能直接压缩，需要先转成es5
// });


// 5.ES6转成ES5
// gulp.task('babel', function () {
// 	return gulp.src('src/sanweitang/js/denglu.js')
// 		.pipe(babel({
// 			'presets': ['es2015']
// 		}))
